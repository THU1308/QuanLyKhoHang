...
namespace QLKHO.Controllers
{
    public class TaiKhoansController : Controller
    {
        ...
        {
            TaiKhoan taiKhoan = db.TaiKhoan.Find(int.Parse(Session["matk"].ToString()));
            if (taiKhoan == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult UpdateProfile([Bind(Include = "MaTK,TenTK,MaPQ,MatKhau,SoDienThoai,Email,HoTen,NgaySinh,Anh")] TaiKhoan taiKhoan)
        {
            ...
            ViewBag.AlertMessage = null; // Đặt ViewBag.AlertMessage thành null khi ModelState.IsValid là false
            ViewBag.MaPQ = new SelectList(db.PhanQuyen, "MaPQ", "TenPQ", taiKhoan.MaPQ);
            return View(taiKhoan);
        }
