...
namespace QuanLyKhoHang.Controllers
{
    public class NhaCungCapsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaNCC,TenNCC,Email,Fax,SoDienThoai")] NhaCungCap nhaCungCap)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaNCC,TenNCC,Email,Fax,SoDienThoai")] NhaCungCap nhaCungCap)
        {
            if (ModelState.IsValid)
            {
